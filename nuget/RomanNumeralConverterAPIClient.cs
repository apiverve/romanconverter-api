...
namespace APIVerve.API.RomanNumeralConverter
{
    ...
    /// <summary>
    /// Client for the RomanNumeralConverter API
    /// </summary>
    public class RomanNumeralConverterAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/romanconverter";
        ...
        {
            { "number", new ValidationRule { Type = "integer", Required = true, Min = 1, Max = 3999 } }
        };
        ...
        public RomanNumeralConverterAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public RomanNumeralConverterAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public RomanNumeralConverterAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, RomanNumeralConverterQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(RomanNumeralConverterQueryOptions options)
        {
        ...
        public ResponseObj Execute(RomanNumeralConverterQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(RomanNumeralConverterQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(RomanNumeralConverterQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(RomanNumeralConverterQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(RomanNumeralConverterQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(RomanNumeralConverterQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(RomanNumeralConverterQueryOptions options)
        {
