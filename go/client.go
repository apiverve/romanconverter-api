...
const (
	baseURL        = "https://api.apiverve.com/v1/romanconverter"
	defaultTimeout = 30 * time.Second
)

// Client is the Roman Numeral Converter API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Roman Numeral Converter API client.
...
// Execute makes a request to the Roman Numeral Converter API with typed parameters.
//
