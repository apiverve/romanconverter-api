// Package romanconverter provides a Go client for the Roman Numeral Converter API.
//
// For more information, visit: https://apiverve.com/marketplace/romanconverter?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the Roman Numeral Converter API.
//
// Parameters:
//   - number (required): integer - The number to convert to Roman numerals [min: 1, max: 3999]
type Request struct {
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		"number": {Type: "integer", Required: true, Min: float64Ptr(1), Max: float64Ptr(3999)},
	}
...
// ResponseData contains the data returned by the Roman Numeral Converter API.
...
// BreakdownData represents the breakdown object.
