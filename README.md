...
```bash
curl -X GET "https://api.apiverve.com/v1/romanconverter?param=value" \
...
📚 **Full API Documentation:** [https://docs.apiverve.com/ref/romanconverter](https://docs.apiverve.com/ref/romanconverter)

---

## Use Cases

Common use cases for the Roman Numeral Converter API:
