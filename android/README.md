# Roman Numeral Converter Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:romanconverter-api:1.1.13'
}
```
...
```java
import com.apiverve.romanconverter.RomanNumeralConverterAPIClient;
import com.apiverve.romanconverter.APIResponse;
import com.apiverve.romanconverter.APIException;

// Initialize the client
RomanNumeralConverterAPIClient client = new RomanNumeralConverterAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("number", 2024);
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/romanconverter](https://docs.apiverve.com/ref/romanconverter)
...
- **Documentation:** [https://docs.apiverve.com/ref/romanconverter](https://docs.apiverve.com/ref/romanconverter)
- **Issues:** [GitHub Issues](https://github.com/apiverve/romanconverter-api/issues)
