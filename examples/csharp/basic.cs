...
{
    class RomanNumeralConverterExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/romanconverter";

        /// <summary>
        /// Make a GET request to the Roman Numeral Converter API
        /// </summary>
        static async Task<JsonDocument> CallRomanNumeralConverterAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;number&quot;] &#x3D; 2024, [&quot;roman&quot;] &#x3D; &quot;MMXXIV&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Roman Numeral Converter API...\n");

            var result = await CallRomanNumeralConverterAPI();
